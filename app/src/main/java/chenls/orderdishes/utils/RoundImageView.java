...
public class RoundImageView extends ImageView {
    ...
    public RoundImageView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
        ...
        final int default_data = (int) (2 * paramContext.getResources().getDisplayMetrics().density + 0.5f);
        mBorderWidth = a.getDimensionPixelOffset(R.styleable.CircularImage_border_width, default_data);
        a.recycle();
    }
