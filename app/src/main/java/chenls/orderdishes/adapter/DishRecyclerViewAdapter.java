...
//        holder.tv_signboard.setVisibility(dish.);
    ...
    private void addClick(ViewHolder holder) {
        ...
        mListener.onDishListButtonClick(Integer.parseInt(dish.getCategory()), 1
                , Integer.parseInt(dish.getPrice()), dish.getName(),
                holder.getAdapterPosition(), dish.getPic().getFileUrl(context));
